...
public class PermissionDAOImpl implements PermissionDAO{
    ...
    public Integer addPermission(Permission permission) {
        ...
        try {
            ...
            pstmt.setString(3, permission.getCreatedBy());
    ...
    public Integer updatePermission(Permission permission) {
        ...
        try {
            ...
            pstmt.setString(1, permission.getPermission());
            pstmt.setDate(2, sqlDate);
            pstmt.setString(3, permission.getModifiedBy());
    ...
    public Permission getPermissionById(Integer id) {
        ...
        try {
            ...
            if(rs.next()){
                ...
                permission.setCreatedBy(rs.getString(COLUMN_CREATED_BY));
                permission.setModifiedDate(rs.getDate(COLUMN_MODIFIED_DATE));
                permission.setModifiedBy(rs.getString(COLUMN_MODIFIED_BY));
