...
public class RoleDAOImpl implements RoleDAO{
    ...
    public Integer addRole(Role role) {
        ...
        try {
            ...
            pstmt.setString(3, role.getCreatedBy());
    ...
    public Integer updateRole(Role role) {
        ...
        try {
            ...
            pstmt.setString(3, role.getModifiedBy());
    ...
    public Role getRoleById(Integer id) {
        ...
        try {
            ...
            if(rs.next()){
                ...
                role.setCreatedBy(rs.getString(COLUMN_CREATED_BY));
                role.setModifiedDate(rs.getDate(COLUMN_MODIFIED_DATE));
                role.setModifiedBy(rs.getString(COLUMN_MODIFIED_BY));
