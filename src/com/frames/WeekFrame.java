...
import com.DAOImpl.WeekDAOImpl;
...
public class WeekFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        weekTable.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        weekTable.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        weekField.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(74, 74, 74)
                .addComponent(weekField, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(weekField, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void weekTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_weekTableMouseClicked
      ...
      id = (Integer) weekTable.getValueAt(weekTable.getSelectedRow(), 0);
        
      week = weekDAOImpl.getWeekById(id);
      weekField.setText(week.getWeekName());
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if(weekField.getText().equals("")){
            ...
            String inputWeek = weekField.getText();
            
            Week w = new Week();
            w.setWeekName(inputWeek);
            w.setCreatedDate(todaysDate);
            w.setCreatedBy(u.getUserName());
            
            int result = weekDAOImpl.addWeek(w);
            
            if(result > 0){
                JOptionPane.showMessageDialog(null, w.getWeekName()+" week added successfully!");
                fillTable();
            }else{
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
       String inputWeek = weekField.getText();
       Week w = weekDAOImpl.getWeekById(id);
       w.setWeekName(inputWeek);
       w.setModifiedDate(todaysDate);
       w.setModifiedBy(u.getUserName());
        
        int selection = JOptionPane.showConfirmDialog(null, "Do you want to update Week: " + week.getWeekName()+ "?", null, 0);
        if(selection ==0){
            Integer result = weekDAOImpl.updateWeek(w);
        
        if(result > 0){
        
            JOptionPane.showMessageDialog(null, week.getWeekName()+" Updated Successfully!");
            clearFields();
            fillTable();
        }else{
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
       ...
       int r =  JOptionPane.showConfirmDialog(null, "Do you want to delete "+week.getWeekName()+"?");
       if(r == 0){
        Integer result = weekDAOImpl.deleteWeek(id);
        
        if(result > 0){
        
            JOptionPane.showMessageDialog(null, week.getWeekName()+" Deleted Successfully!");
            clearFields();
            fillTable();
        }else{
    ...
    public void fillTable(){
        ...
        List<Week> allWeeks = weekDAOImpl.getAllWeek();
        
        for(Week w:allWeeks){
            
            Object rowData[] = {w.getWeekId(),w.getWeekName(),w.getCreatedDate(),w.getCreatedBy(),w.getModifiedDate(),w.getModifiedBy()};
            
            model.addRow(rowData);
            weekTable.setModel(model);
    ...
    public void checkPermission(){
        ...
        for(int i=0; i<allAssignedPermission.size(); i++){
            ...
            if(allAssignedPermission.get(i).getPermission().equalsIgnoreCase("Add week")){
            
                addButton.setEnabled(true);
            }
            if(allAssignedPermission.get(i).getPermission().equalsIgnoreCase("update week")){updateButton.setEnabled(true);}
            if(allAssignedPermission.get(i).getPermission().equalsIgnoreCase("delete week")){deleteButton.setEnabled(true); }
